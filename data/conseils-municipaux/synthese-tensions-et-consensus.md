# Thorigné-Fouillard: points de friction et points de consensus (2020-2026)

## Méthode

Cette synthèse s'appuie sur les 49 résumés produits localement dans `data/conseils-municipaux/videos/*/summary.md`.

Elle ne remplace pas une relecture intégrale des verbatims, mais elle suffit pour dégager les thèmes récurrents:

- ce qui oppose régulièrement majorité et opposition
- ce qui suscite surtout des abstentions ponctuelles
- ce qui passe le plus souvent sans conflit majeur

Note: deux vidéos portent des dates futures par rapport au 13 mars 2026 (`2026-03-20` et `2026-03-30`). Elles ont été peu utilisées dans l'analyse, car leur datation mérite vérification.

## Ce qui a le plus opposé majorité et opposition

### 1. Urbanisme, foncier et ZAC multisite

C'est de loin la ligne de fracture la plus constante du mandat.

Les désaccords portent surtout sur:

- la stratégie de renouvellement urbain et de densification
- les préemptions foncières et le risque d'expropriation
- le périmètre et le calendrier de la ZAC multisite
- le manque d'information reproché à l'exécutif sur les projets derrière chaque acquisition
...
### 2. Budgets, investissements et sincérité financière

Le deuxième grand sujet de friction est budgétaire.

Les points récurrents:

- l'opposition juge souvent les projections trop optimistes
- elle critique le niveau d'investissement, le calendrier des dépenses et le manque de visibilité
- la majorité défend une logique d'investissement assumée, présentée comme nécessaire pour moderniser la commune
...
### 3. Hiérarchie des investissements et grands équipements

Quand un projet d'équipement devient visible et coûteux, le conflit revient.

Les cas les plus nets:

- salle de billard
- complexe des 3 raquettes / padel
- parfois extension scolaire, EHPAD ou skatepark
...
### 4. Gouvernance municipale, transparence et place de l'opposition

C'est un conflit transversal, présent dès le début du mandat.

Les reproches récurrents de l'opposition:

- information tardive ou incomplète
- pièces modifiées entre préparation et séance
- procès-verbaux jugés incomplets
- décisions trop avancées avant débat politique réel
...
### 5. Social et services locaux: moins souvent le fond, plus souvent le périmètre ou le montage

Sur le social, il y a moins de conflits idéologiques massifs, mais plusieurs désaccords sur le montage concret:

- financement du CCAS ou de l'EHPAD
- logements d'urgence et logement temporaire
- rôle exact de la commune par rapport à d'autres acteurs
...
## Ce qui a plutôt peu posé problème

### 1. Les délibérations de gestion courante

Ce sont les points qui passent le plus souvent à l'unanimité ou avec très peu de débat:

- ajustements RH et créations/suppressions de postes techniques
- conventions administratives
- ouvertures dominicales
- créances irrécouvrables
- renouvellements de conventions ou d'adhésions
- jury, commissions, remplacements dans les instances
...
- les subventions courantes
- les prix culturels
- les conventions de mise à disposition
- les petits soutiens logistiques

passent assez bien.

Les tensions apparaissent surtout:

- quand les critères d'attribution sont contestés
- quand une clause ou un montage est jugé peu clair
...
Les séances très procédurales semblent peu conflictuelles, sauf au tout début du mandat sur les délégations accordées au maire.
...
Plusieurs dossiers sont d'abord discutés, puis votés plus largement une fois le cadre clarifié:

- certains volets de l'EHPAD
- plusieurs blocs techniques des budgets
- certaines conventions scolaires ou métropolitaines
- le PLH 2023-2028
...
Si on simplifie fortement, les 6 ans de débats montrent ceci:

- **désaccord structurel** sur l'urbanisme, le foncier et la densification
- **désaccord récurrent** sur le budget, la sincérité financière et la hiérarchie des investissements
- **désaccord méthodologique** sur la transparence et la place de l'opposition
- **consensus fréquent** sur la gestion courante, les mesures techniques et une partie de la vie locale

Autrement dit, le clivage principal n'est pas sur les petites décisions municipales du quotidien. Il se cristallise surtout quand la commune engage sa trajectoire à long terme: où construire, combien investir, dans quel ordre, et avec quel degré d'information partagée.

## Si tu veux aller plus loin

Les deux suites les plus utiles seraient:

1. coder chaque séance avec 3 niveaux: `consensuel`, `abstentions`, `conflit ouvert`
2. établir un tableau par grand thème (`urbanisme`, `budget`, `équipements`, `gouvernance`, `social`) avec:
